...
try:
    for epoch in range(n_epochs):
        ...
        for start, end in zip(
            ...
            # SMITH: If iterations rise to 20,000, we stop the training and save the model
            if iterations >= end_point:
                saver.save(sess, os.path.join(os.getcwd(), "models/"+str(iterations)))
